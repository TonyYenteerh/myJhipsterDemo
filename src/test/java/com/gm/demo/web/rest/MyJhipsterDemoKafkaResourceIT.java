...
@WithMockUser
@EmbeddedKafka
class MyJhipsterDemoKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/my-jhipster-demo-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/my-jhipster-demo-kafka/consume")
